...
SECRET_KEY = 'django-insecure-3y$$a$ff@ksgmwow#+@9=#n_!k=pengov+!0e)u4@(683!afr1'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.yngpborwividxkmzlcel',   # from your pooler string, the part before the colon-password
